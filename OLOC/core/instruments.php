				...
				<div class="container">
					<div class="row d-flex justify-content-center pb-40">
						<div class="col-md-8 pb-40 header-text">
							<h1 class="text-center pb-10">Choose your desired location</h1>
							<p class="text-center">
								Our packages
							</p>
						</div>
					...
					?>
						...
						<div class="row align-items-center single-model item">
							<div class="col-lg-6 model-left">
								...
								<a class="text-uppercase primary-btn" href="view_instrument.php?instrument_id=<?php echo $row->instrument_id;?>">package Details</a>
							</div>
